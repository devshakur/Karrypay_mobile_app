...
export default function EducationSuccess() {
      ...
      <View style={[styles.container]}>
        ...
        <View style={styles.content}>
          ...
          <Text style={[styles.subtitle, { color: "#fff" }]}>
            Your WAEC Result Checker PIN has been generated.
          </Text>
          <View
            style={{
              backgroundColor: isDark ? theme.colors.primary + "20" : "#F5F6FD",
              padding: 10,
              width: "90%",
              borderRadius: 10,
              marginTop: 20,
          ...
          >
            ...
            <Text style={{ fontFamily: "ManropeMedium", textAlign: "center" }}>
              1234 5678 9012 3456
            </Text>
          </View>
        </View>
